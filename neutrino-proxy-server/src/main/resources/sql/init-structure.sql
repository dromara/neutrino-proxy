...
CREATE INDEX IF NOT EXISTS I_user_id ON user_token(user_id);
CREATE INDEX IF NOT EXISTS I_token ON user_token(token);
CREATE INDEX IF NOT EXISTS I_expiration_time ON user_token(expiration_time);
...
CREATE INDEX IF NOT EXISTS I_create_time ON flow_report_minute(create_time);
CREATE INDEX IF NOT EXISTS I_date ON flow_report_minute(`date`);
CREATE INDEX IF NOT EXISTS I_user_id ON flow_report_minute(`user_id`);
CREATE INDEX IF NOT EXISTS I_license_id ON flow_report_minute(`license_id`);
...
CREATE INDEX IF NOT EXISTS I_create_time ON flow_report_hour(create_time);
CREATE INDEX IF NOT EXISTS I_date ON flow_report_hour(`date`);
CREATE INDEX IF NOT EXISTS I_user_id ON flow_report_hour(`user_id`);
CREATE INDEX IF NOT EXISTS I_license_id ON flow_report_hour(`license_id`);
...
CREATE INDEX IF NOT EXISTS I_create_time ON flow_report_day(create_time);
CREATE INDEX IF NOT EXISTS I_date ON flow_report_day(`date`);
CREATE INDEX IF NOT EXISTS I_user_id ON flow_report_day(`user_id`);
CREATE INDEX IF NOT EXISTS I_license_id ON flow_report_day(`license_id`);
...
CREATE INDEX IF NOT EXISTS I_create_time ON flow_report_month(create_time);
CREATE INDEX IF NOT EXISTS I_date ON flow_report_month(`date`);
CREATE INDEX IF NOT EXISTS I_user_id ON flow_report_month(`user_id`);
CREATE INDEX IF NOT EXISTS I_license_id ON flow_report_month(`license_id`);